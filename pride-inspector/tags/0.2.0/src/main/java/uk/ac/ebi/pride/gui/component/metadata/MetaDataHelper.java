...
public class MetaDataHelper {
    ...
    public static Collection<Parameter> getReference(Reference reference) {
        ...
        customParams.addCvParams(reference.getCvParams());
        customParams.addUserParams(reference.getUserParams());
