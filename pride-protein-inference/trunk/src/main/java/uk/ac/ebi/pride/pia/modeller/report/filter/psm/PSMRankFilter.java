...
public class PSMRankFilter extends AbstractFilter {
	
	protected static final String shortName = RegisteredFilters.PSM_RANK_FILTER.getShortName();
	
	protected static final String name = "Rank Filter for PSM";
	
	protected static final String filteringName = "Rank (PSM)";
	...
	public PSMRankFilter(FilterComparator arg, Integer value, boolean negate) {
		this.comparator = arg;
		this.value = value;
		this.negate = negate;
	}
