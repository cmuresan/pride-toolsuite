...
public class NrPSMsPerPeptideFilter extends AbstractFilter {
	
	protected static final String shortName = RegisteredFilters.NR_PSMS_PER_PEPTIDE_FILTER.getShortName();
	
	protected static final String name = "#PSMs per Peptide Filter";
	
	protected static final String filteringName = "#PSMs per Peptide";
	...
	public NrPSMsPerPeptideFilter(FilterComparator arg, Integer value, boolean negate) {
		this.comparator = arg;
		this.value = value;
		this.negate = negate;
	}
