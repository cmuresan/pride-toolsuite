 ...
 * Time: 16:39:59
 */
public class QuartilesDataSeries<T,U> {
    /**
     ...
     */
    public QuartilesDataSeries(JSONObject data) {
        this.data = data;
    }
     ...
     * <p> Creates an instance of this DataSeries object, setting all fields as per description below.</p>
     *
     * @param type The quartiles type
     * @param identifier The series identifier
     * @param data a list of SeriesPair containing the chart intermediate data
     */
    public QuartilesDataSeries(QuartilesType type, String identifier, List<SeriesPair<T,U>> data) {
