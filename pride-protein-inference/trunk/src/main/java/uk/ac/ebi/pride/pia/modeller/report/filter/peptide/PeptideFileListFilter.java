...
public class PeptideFileListFilter extends AbstractFilter {
	
	protected static final String shortName = RegisteredFilters.PEPTIDE_FILE_LIST_FILTER.getShortName();
	
	protected static final String name = "File List Filter for Peptide";
	
	protected static final String filteringName = "File List (Peptide)";
	...
	public PeptideFileListFilter(FilterComparator arg, String value, boolean negate) {
		this.comparator = arg;
		this.value = value;
		this.negate = negate;
	}
