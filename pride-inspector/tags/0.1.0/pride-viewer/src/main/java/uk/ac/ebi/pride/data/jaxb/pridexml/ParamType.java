...
@XmlSeeAlso({
    uk.ac.ebi.pride.data.jaxb.pridexml.SpectrumSettingsType.AcqSpecification.Acquisition.class,
    uk.ac.ebi.pride.data.jaxb.pridexml.SpectrumSettingsType.SpectrumInstrument.class,
