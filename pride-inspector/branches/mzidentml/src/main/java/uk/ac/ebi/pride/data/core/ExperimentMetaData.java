...
public class ExperimentMetaData extends IdentifiableParamGroup {
     ...
     * @param protocol
     */
    public ExperimentMetaData(Comparable id, String name, String version, String shortLabel, List<Sample> sampleList,
                              List<Software> softwareList, List<Person> personList, List<SourceFile> sourceFiles,
                              Provider provider, List<Organization> organizationList, List<Reference> references,
                              Date creationDate, Date publicDate, ExperimentProtocol protocol) {
        super(id, name);
