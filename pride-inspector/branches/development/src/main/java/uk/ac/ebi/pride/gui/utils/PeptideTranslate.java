...
/**
 * Translate uk.ac.ebi.pride.data.core.Peptide into uk.ac.ebi.pride.iongen.model.Peptide
 *
 * Creator: Qingwei-XU
 * Date: 19/10/12
 */
...
public class PeptideTranslate {
    ...
    private List<uk.ac.ebi.pride.data.core.Modification> oldModifications;

    public PeptideTranslate(uk.ac.ebi.pride.data.core.Peptide oldPeptide) {
    ...
    public Peptide translate() {
        ...
        for (uk.ac.ebi.pride.data.core.Modification oldModification : oldModifications) {
            ...
            label = oldModification.getAccession();
            monoMassDeltas = oldModification.getMonoMassDeltas();
            avgMassDeltas = oldModification.getAvgMassDeltas();
