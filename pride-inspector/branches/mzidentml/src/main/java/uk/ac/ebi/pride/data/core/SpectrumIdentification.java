...
public class SpectrumIdentification extends ProtocolApplication{
    ...
    public SpectrumIdentification(String id, String name, String activeDate, SpectrumIdentificationProtocol spectrumIdentificationProtocolRef, SpectrumIdentificationList spectrumIdentificationListRef, List<SpectraData> inputSpectraList, List<SearchDataBase> searchDataBaseList) {
