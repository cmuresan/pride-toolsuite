...
public enum CacheCategory {
    ...
    IDENTIFICATION_TO_PEPTIDE_EVIDENCES(HashMap.class, null),       //Map<Comparable,Map<Comparable, List<String[]>>>
    IDENTIFICATION_PROTEIN_GROUP_ID(HashMap.class,null),            // Map<Comparable, Comparable>
    ...
    IDENTIFICATION_METADATA(ArrayList.class, null),                  // ToDo: document
