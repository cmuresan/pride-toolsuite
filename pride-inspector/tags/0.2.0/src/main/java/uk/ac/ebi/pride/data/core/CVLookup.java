...
public class CVLookup implements MassSpecObject {
    ...
    public void setAddress(String address) {
        if (address == null) {
            throw new IllegalArgumentException("CVLabel's address can not be NULL");
        } else {
    ...
    public void setCvLabel(String cvLabel) {
        if (cvLabel == null) {
            throw new IllegalArgumentException("CVLabel can not be NULL");
        } else {
    ...
    public void setFullName(String fullName) {
        if (fullName == null) {
            throw new IllegalArgumentException("CVLabel's full name can not be NULL");
        } else {
