...
public class NrAccessionsPerPSMFilter extends AbstractFilter {
	
	protected static final String shortName = RegisteredFilters.NR_ACCESSIONS_PER_PSM_FILTER.getShortName();
	
	protected static final String name = "#Accessions per PSM";
	
	protected static final String filteringName = "#Accessions per PSM";
	...
	public NrAccessionsPerPSMFilter(FilterComparator arg, Integer value, boolean negate) {
		this.comparator = arg;
		this.value = value;
		this.negate = negate;
	}
