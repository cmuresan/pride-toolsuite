package uk.ac.ebi.pride.pia.modeller.execute;
...
public interface ExecuteModelCommands<T> {
	 ...
	 * @return
	 */
	public abstract boolean execute(T modeller, String[] params);
	 ...
	 * @param model
	 */
	public abstract void executeXMLParameters(NODEType node, T model);
