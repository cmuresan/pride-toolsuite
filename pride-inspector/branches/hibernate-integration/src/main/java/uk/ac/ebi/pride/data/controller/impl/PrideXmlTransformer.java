...
public class PrideXmlTransformer {
    ...
    private static String SOURCE_FILE_ID = "sourcefile1";
    private static String SOURCE_FILE_TYPE = "source file type";
    ...
    public Protocol transformProtocol(uk.ac.ebi.pride.jaxb.model.Protocol rawProt) {
        ...
        if (rawProt != null) {
            List<uk.ac.ebi.pride.jaxb.model.Param> rawSteps = rawProt.getProtocolSteps().getStepDescription();
