...
import uk.ac.ebi.pridemod.io.psimod.PSIModReader;
...
public class PSIModDataAccessController extends AbstractDataAccessController{
     ...
     * very begining to improve the performance of the application. The present function convert all terms from PSI-MOD to
