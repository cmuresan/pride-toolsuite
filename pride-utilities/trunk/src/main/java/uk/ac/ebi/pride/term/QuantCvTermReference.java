...
public enum QuantCvTermReference {
    ...
    public static boolean isQuantitativeMethodParam(String accession) {
        return isIsotopeLabellingMethodParam(accession) || isLabelFreeMethod(accession);
    }

    public static QuantCvTermReference getQuantitativeMethodParam(String accession) {
        QuantCvTermReference cvTerm = getIsotopeLabellingMethodParam(accession);
        if (cvTerm == null) {
            cvTerm = getLabelFreeMethod(accession);
        }
        return cvTerm;
    }

    public static boolean isIsotopeLabellingMethodParam(String accession) {
    ...
    public static QuantCvTermReference getIsotopeLabellingMethodParam(String accession) {
    ...
    public static int getIntensityParamIndex(String accession) {
    ...
    public static boolean isStandardDeviationParam(String accession) {
    ...
    public static int getStandardErrorParamIndex(String accession) {
    ...
    public static boolean isLabelFreeMethod(String accession) {
    ...
    public static QuantCvTermReference getLabelFreeMethod(String accession) {
    ...
    public static QuantCvTermReference getUnit(String accession) {
    ...
    public static String getReagentShortLabel(String accession) {
    ...
    public static boolean isSubSampleDescription(String accession) {
