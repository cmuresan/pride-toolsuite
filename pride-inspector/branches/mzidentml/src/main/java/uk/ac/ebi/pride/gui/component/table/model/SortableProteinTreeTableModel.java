...
import uk.ac.ebi.pride.gui.component.table.sorttreetable.SortableTreeTableModel;
...
/**
 * Created by yperez on 07/06/2014.
 */
 ...
 */
        ...
        if (proteinAccession != null) {
            ...
            if (mappedAccession != null) {
                ...
                if (protein != null) {
                   ...
                   // valueForPathChanged(new TreePath(parentProteinTableRow), childProteinTableRow);
                }
            }
        }
    }
    ...
    private void updateSequenceCoverageData(Map<Comparable, Double> coverageMap,
        ...
        if (coverage != null) {
            ...
            childProteinTableRow.updatePropertyObject(columnNames, proteinScores);
            // notify a row change
            //modelSupport.fireChildChanged(new TreePath(parentProteinTableRow),getIndexOfChild(parentProteinTableRow, childProteinTableRow), childProteinTableRow);
           // valueForPathChanged(new TreePath(parentProteinTableRow), childProteinTableRow);
        }
    }
