 ...
 * Date: 14/06/13
 */
public class PrideHistogramDataset extends AbstractIntervalXYDataset
     ...
     */
    public PrideHistogramDataset(double binWidth) {
        if (binWidth < 1) {
            throw new IllegalArgumentException("Histogram bin width should not less than 1");
        }
    ...
    /**
     * Sets the histogram type and sends a {@link org.jfree.data.general.DatasetChangeEvent} to all
    ...
    public void addSeries(Comparable key,
        ...
        int bins = (int) Math.floor((maximum - minimum) / binWidth);
     ...
     *     specified range.
     */
    public List<HistogramBin> getBins(int series) {
    ...
    public boolean equals(Object obj) {
        ...
        PrideHistogramDataset that = (PrideHistogramDataset) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        PrideHistogramDataset clone = (PrideHistogramDataset) super.clone();
