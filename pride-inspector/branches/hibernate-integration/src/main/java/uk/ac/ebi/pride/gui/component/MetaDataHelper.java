...
public class MetaDataHelper {
    ...
    public static Collection<Parameter> getReference(Reference reference) {
        ...
        // additional parameters
        addParamGroup(params, reference, SharedLabels.EMPTY);
        ...
        if (paramGroup != null) {
            ...
            if (cvParams != null) {
                for (CvParam cvParam : cvParams) {
                    ...
                    params.add(new CvParam(cvParam.getAccession(), name, cvParam.getCvLookupID(),
                                value, cvParam.getUnitAcc(), cvParam.getUnitName(), cvParam.getUnitCVLookupID()));
                }
            }
            ...
            if (userParams != null) {
                for (UserParam userParam : userParams) {
                    params.add(new UserParam(prefix + userParam.getName(), userParam.getType(), userParam.getValue(),
