...
public class PeptideDescriptionFilter extends AbstractFilter {
	
	protected static final String shortName = RegisteredFilters.PEPTIDE_DESCRIPTION_FILTER.getShortName();
	
	protected static final String name = "Description Filter for Peptide";
	
	protected static final String filteringName = "Description (peptide)";
	...
	public PeptideDescriptionFilter(FilterComparator arg, String value, boolean negate) {
		this.comparator = arg;
		this.value = value;
		this.negate = negate;
	}
