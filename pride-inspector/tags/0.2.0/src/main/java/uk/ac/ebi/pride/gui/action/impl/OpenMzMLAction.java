...
public class OpenMzMLAction extends PrideAction {
    public OpenMzMLAction() {
        ...
        this.setAccelerator(java.awt.event.KeyEvent.VK_M, ActionEvent.CTRL_MASK);
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        OpenFileDialog ofd = new OpenFileDialog(System.getProperty("user.dir"), "Select mzML Files", ".mzml", ".xml");
