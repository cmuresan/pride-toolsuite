...
public class Modification extends ParamGroup {
    ...
    public void setAccession(String accession) {
        if (accession == null) {
            throw new IllegalArgumentException("Modification accession can not be NULL");
        } else {
    ...
    public String getName() {
        if (name == null) {
            for (CvParam cvParam : this.getCvParams()) {
    ...
    public void setModDatabase(String modDatabase) {
        if (modDatabase == null) {
            throw new IllegalArgumentException("Modification database can not be NULL");
        } else {
