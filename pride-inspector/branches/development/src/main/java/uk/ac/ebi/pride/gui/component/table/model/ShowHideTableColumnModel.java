...
/**
 * <code>ShowHideTableColumnModel</code> extends the DefaultTableColumnModel .
 * It provides a way to hide/show columns.
 ...
 */
public class ShowHideTableColumnModel extends DefaultTableColumnModel {
    /**
    ...
    public ShowHideTableColumnModel() {
    }
    ...
    public void setColumnVisible(TableColumn column, boolean visible) {
        if (!visible) {
            ...
            int numVisibleColumns = tableColumns.size();
            int numInvisibleColumns = allTableColumns.size();
            int visibleIndex = 0;

            for (int invisibleIndex = 0; invisibleIndex < numInvisibleColumns; ++invisibleIndex) {
                TableColumn visibleColumn = (visibleIndex < numVisibleColumns ? tableColumns.get(visibleIndex) : null);
    ...
    public void setAllColumnsVisible() {
        int numColumns = allTableColumns.size();
    ...
    public TableColumn getColumn(int columnIndex, boolean onlyVisible) {
        return onlyVisible ? tableColumns.elementAt(columnIndex) : allTableColumns.elementAt(columnIndex);
    }
}
